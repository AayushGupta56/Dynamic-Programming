...
int longestPalindromeSubsequence(string s)
{
    ...
    //the longest subsequence in s and t will be ans because only order palindromic
    //subsequence will not change after reversing if it is not palindromic subseq then 
    //it will not remain common as order will change
